...
DEVICE_PORT = 5555          # Change to your adb device's port number
...
BOX_RESULT_TEMPLATE        = ["BOX_RESULT_1.png"]
BOX_RESULT_ROI             = (830, 140, 1280, 480)
STAGE_CONGRATULATIONS_TEMPLATE = ["CONGRATULATIONS_1.png", "CONGRATULATIONS_2.png"]
STAGE_LEVEL_UP_TEMPLATE = ["LEVEL_UP_1.png"]
STAGE_RELIC_COMPLETE_TEMPLATE = ["RELIC_COMPLETE_1.png", "relic_get.png"]
STAGE_RELIC_CLAIM_TEMPLATE = ["RELIC_CLAIM_1.png", "relic_title.png"]
...
# GIFT DRAW TEMPLATES
# -------------------
GIFT_DRAW_TITLE_TEMPLATE = ["GIFT_DRAW_TITLE_1.png"]
GIFT_PICK_TEMPLATE       = ["GIFT_PICK_1.png"]

# Gift Draw Detection Region (full-width title bar at top)
GIFT_DRAW_TITLE_REGION = (350, 30, 900, 130)
# Pick-a-box banner (centre of screen)
GIFT_PICK_REGION       = (200, 100, 1000, 400)

# Gift Draw match threshold
GIFT_DRAW_THRESHOLD = 0.75

# Maximum draw iterations before giving up
GIFT_DRAW_MAX = 2000

# -------------------
# COIN TRACKING (OCR)
# -------------------
# Template for detecting the Result/Game-Complete screen
RESULT_SCREEN_TEMPLATE = ["RESULT_SCREEN_1.png"]
RESULT_SCREEN_REGION   = (523, 27, 757, 116)   # same area as GAME_COMPLETE
RESULT_SCREEN_THRESHOLD = 0.75

# Region on the Result screen where the coin number appears (x1,y1,x2,y2)
# Source: COIN_LOG_ROI from CookieGame_Multi (945,383,1118,430) — 1280×720
COIN_ROI = (945, 383, 1118, 430)

# Path to digit templates folder (relative to template dir)
DIGIT_TEMPLATE_SUBDIR = "digits"

# Digit resize dimensions used for OCR matching
DIGIT_GW = 24
DIGIT_GH = 36
...
STAGE_MULTIBUY_STOP_TEMPLATE = ["multibuy_stop.png"]

MULTI_BOOST_CHECKBOXES = [
    {"index": 0,  "name": "Double Coins",           "pos": (285, 176)},
    {"index": 1,  "name": "+15% Score Bonus",       "pos": (685, 176)},
    {"index": 2,  "name": "-15% HP Drain",          "pos": (285, 225)},
    {"index": 3,  "name": "Revive once 80HP",       "pos": (685, 225)},
    {"index": 4,  "name": "70% Crush Chance",       "pos": (285, 274)},
    {"index": 5,  "name": "+17% Base Speed",        "pos": (685, 274)},
    {"index": 6,  "name": "Gold Coin Magic",        "pos": (285, 324)},
    {"index": 7,  "name": "-30% Collision Damage",  "pos": (685, 324)},
    {"index": 8,  "name": "+20% HP from Potions",   "pos": (285, 373)},
    {"index": 9,  "name": "Magnetic Aura",          "pos": (685, 373)},
    {"index": 10, "name": "2 Pit Lifts",            "pos": (285, 423)},
]
...
JUMP_BUTTON = (120, 540)
SLIDE_BUTTON = (1180, 650)

# -------------------
# GIFT DRAW BUTTONS
# -------------------
GIFT_ICON_BUTTON    = (400, 672)   # ไอคอนกล่องของขวัญใน Lobby
GIFT_DRAW_BUTTON    = (930, 613)   # ปุ่ม Draw ในหน้า Gift Draw
GIFT_BOX_BUTTON     = (640, 345)   # เลือกกล่อง
GIFT_SKIP_BUTTON    = (640, 360)   # Skip animation
GIFT_AGAIN_BUTTON   = (797, 575)   # Draw Again
GIFT_CONFIRM_BUTTON = (479, 573)   # Confirm (ไอเทมปกติ)
GIFT_PET_BUTTON     = (640, 575)   # Confirm (ได้สัตว์เลี้ยง)
GIFT_CLOSE_BUTTON   = (1123, 113)  # ปิดหน้า Gift Draw
GIFT_ESC_BUTTON     = (1013, 107)  # Escape / X ในหน้าที่ไม่รู้จัก
